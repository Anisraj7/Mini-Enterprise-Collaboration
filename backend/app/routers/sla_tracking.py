...
def get_active_sla(
    ...
    return SLATrackingService.get_active_sla(
        db
    )
...
def get_breached_sla(
    ...
    return (
        SLATrackingService.get_breached_sla(
            db
        )
    )
...
def get_completed_sla(
    ...
    return SLATrackingService.get_completed_sla(db)
...
def get_sla_by_module(
    ...
    return SLATrackingService.get_by_module(
        db,
        module_name,
    )
