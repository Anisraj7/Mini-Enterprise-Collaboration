...
# VERIFY PAYMENT
# -----------------------------------
def verify_payment(payload, user, db: Session):
    ...
    # -----------------------------------
    existing_payment = db.query(Subscription).filter(
    ...
    # ADD CREDITS INSTEAD OF OVERWRITING
...
# -----------------------------------
def get_current_subscription(user, db: Session):
